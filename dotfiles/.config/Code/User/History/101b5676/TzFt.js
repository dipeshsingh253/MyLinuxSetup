        ...
        <div className="my-4">
          ...
          <div class="flex items-center">
            <input
              ...
              class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-red-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
            />
            <label
              for="default-radio-2"
              class="ml-2 text-sm font-semibold text-gray-900 dark:text-gray-300"
